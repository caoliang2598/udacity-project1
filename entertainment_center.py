...
mad_max = Movie("Mad Max: Fury Road",
                ...
                "action and of few words, and Furiosa, a woman of action who "
...
san_andreas = Movie("San Andreas",
                    ...
                    "a rescue-chopper pilot makes a dangerous journey across "
...
avengers_age_of_ultron = Movie("Avengers: Age of Ultron",
                               "When Tony Stark and Bruce Banner try to "
                               "jump-start a dormant peacekeeping program "
                               "called Ultron, things go horribly wrong and "
                               "it's up to Earth's Mightiest Heroes to stop "
                               "the villainous Ultron from enacting his "
                               "terrible plans.",
...
ted_second = Movie("Ted 2",
                   ...
                   "but in order to qualify to be a parent, Ted will have to "
                   "prove he's a person in a court of law.",
